...
function SecondColumn() {
  ...
  return (
    <div className="flex flex-col space-y-2.5 mb-9 md:mb-0">
      ...
      <div className="flex border border-dashed border-gray-300 rounded-lg  w-[362px] md:w-[362px] h-[100px] md:h-[160px] items-center justify-center ">
        + Add new card
      </div>
    </div>
  );
